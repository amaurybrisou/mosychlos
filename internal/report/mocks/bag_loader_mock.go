...
func (m *MockBagLoader) LoadData(ctx context.Context, bag bag.SharedBag, reportType string) (interface{}, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LoadData", ctx, bag, reportType)
...
func (mr *MockBagLoaderMockRecorder) LoadData(ctx, bag, reportType interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LoadData", reflect.TypeOf((*MockBagLoader)(nil).LoadData), ctx, bag, reportType)
}
